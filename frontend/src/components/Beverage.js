  ...
  return (
    <div className="w-[300px] md:w-[700px] flex md:gap-20 justify-between">
      <div className="w-[475px] flex flex-col gap-1">
        {veg === true ? (
          <span className="text-[#9b2948] text-md md:text-xl font-semibold w-max rounded-xl">
            <i className="fa-solid fa-mug-hot"></i> <small>Hot</small>
          </span>
        ) : (
          <span className="text-[#368BC1] text-md md:text-xl font-semibold w-max rounded-xl text-nowrap text-ellipsis">
